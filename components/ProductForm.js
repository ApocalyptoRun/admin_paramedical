    ...
    return (
            <form onSubmit={saveProduct}>
                ...
                {isUploading &&(
                    ...
                    <label className="w-24 h-24 border flex flex-col items-center justify-center text-sm
                    gap-1 text-primary rounded-sm bg-gray-200 cursor-pointer bg-white shadow-sm
                    border-primary">
